<?php
    ...
    if(isset($_POST['show'])){
        ...
        $showProfileSQL = "SELECT * FROM student_registration ORDER BY full_name ASC LIMIT $profile_Limit";
        ...
        if(mysqli_num_rows($showProfileRESULT) > 0){
            while($showProfileROW = mysqli_fetch_array($showProfileRESULT)){
                $showProfileMSG .='
                    <tr>
                        ...
                        <td>'.$showProfileROW['password'].'</td>
                        <td>'.$showProfileROW['class_form'].'</td>
            ...
            $showProfileMSG .='
                    <tr>
                        <td colspan="8"><marquee>SORRY NO STUDENT HAS REGISTERED YET</marquee></td>
                    </tr>
    ...
    //=================================== SET LIMIT
     if(isset($_POST['selectLimit'])){
        ...
        $limitProfileSQL = "SELECT * FROM student_registration ORDER BY full_name ASC LIMIT $selectLimit";
            ...
            while($limitProfileROW = mysqli_fetch_array($limitProfileRESULT)){
                $limitProfileMSG .='
                    <tr>
                        ...
                        <td>'.$limitProfileROW['password'].'</td>
                        <td>'.$limitProfileROW['class_form'].'</td>
     ...
     if(isset($_POST['profileAction'])){
        ...
        $searchProfileSQL = "SELECT * FROM student_registration WHERE account_number = '$profileSearch'";
            ...
            while($searchProfileROW = mysqli_fetch_array($searchProfileRESULT)){
                $searchProfileMSG .='
                    <tr>
                        ...
                        <td>'.$searchProfileROW['password'].'</td>
                        <td>'.$searchProfileROW['class_form'].'</td>
    ...
    if(isset($_POST['actionDel'])){
        ...
        $delStudentSQL = "DELETE FROM student_registration WHERE account_number = '$id'";
