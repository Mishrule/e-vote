                                        ...
                                        <div class="col s3 m3">
                                            <div class="card">
                                                <div class="card-image">
                                                    ...
                                                    <span class="card-title" style="color: red; font-weight: bold; font-size: 15px;">DINNING HALL PREFECT</span>
                                                </div>
        ...
        $(window).on('load', function() {
            ...
            if (dinning_prefectOne) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectOne: dinning_prefectOne
                    },
                    success: function(data) {
                        document.getElementById('dinning_Vote1').innerHTML = data;
                    }
            ...
            if (dinning_prefectTwo) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectTwo: dinning_prefectTwo
                    },
                    success: function(data) {
            ...
            if (dinning_prefectThree) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectThree: dinning_prefectThree
                    },
                    success: function(data) {
            ...
            if (dinning_prefectFour) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectFour: dinning_prefectFour
                    },
                    success: function(data) {
            ...
            if (dinning_prefectFive) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectFive: dinning_prefectFive
                    },
                    success: function(data) {
            ...
            if (dinning_prefectSix) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectSix: dinning_prefectSix
                    },
                    success: function(data) {
            ...
            if (dinning_prefectSeven) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectSeven: dinning_prefectSeven
                    },
                    success: function(data) {
            ...
            if (dinning_prefectEight) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectEight: dinning_prefectEight
                    },
                    success: function(data) {
            ...
            if (dinning_prefectNine) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectNine: dinning_prefectNine
                    },
                    success: function(data) {
            ...
            if (dinning_prefectTen) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefectTen: dinning_prefectTen
                    },
                    success: function(data) {
            ...
            if (dinning_prefect11) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect11: dinning_prefect11
                    },
                    success: function(data) {
            ...
            if (dinning_prefect12) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect12: dinning_prefect12
                    },
                    success: function(data) {
            ...
            if (dinning_prefect13) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect13: dinning_prefect13
                    },
                    success: function(data) {
            ...
            if (dinning_prefect14) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect14: dinning_prefect14
                    },
                    success: function(data) {
            ...
            if (dinning_prefect15) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect15: dinning_prefect15
                    },
                    success: function(data) {
            ...
            if (dinning_prefect16) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect16: dinning_prefect16
                    },
                    success: function(data) {
            ...
            if (dinning_prefect17) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect17: dinning_prefect17
                    },
                    success: function(data) {
            ...
            if (dinning_prefect18) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect18: dinning_prefect18
                    },
                    success: function(data) {
            ...
            if (dinning_prefect19) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect19: dinning_prefect19
                    },
                    success: function(data) {
            ...
            if (dinning_prefect20) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect20: dinning_prefect20
                    },
                    success: function(data) {
            ...
            if (dinning_prefect21) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect21: dinning_prefectOne
                    },
                    success: function(data) {
            ...
            if (dinning_prefect22) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect22: dinning_prefect22
                    },
                    success: function(data) {
            ...
            if (dinning_prefect23) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect23: dinning_prefect23
                    },
                    success: function(data) {
            ...
            if (dinning_prefect24) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect24: dinning_prefect24
                    },
                    success: function(data) {
            ...
            if (dinning_prefect25) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect25: dinning_prefect25
                    },
                    success: function(data) {
            ...
            if (dinning_prefect26) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect26: dinning_prefect26
                    },
                    success: function(data) {
            ...
            if (dinning_prefect27) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect27: dinning_prefect27
                    },
                    success: function(data) {
            ...
            if (dinning_prefect28) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect28: dinning_prefect28
                    },
                    success: function(data) {
            ...
            if (dinning_prefect29) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect29: dinning_prefect29
                    },
                    success: function(data) {
            ...
            if (dinning_prefect30) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect30: dinning_prefect30
                    },
                    success: function(data) {
            ...
            if (dinning_prefect31) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect31: dinning_prefect31
                    },
                    success: function(data) {
            ...
            if (dinning_prefect32) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect32: dinning_prefect32
                    },
                    success: function(data) {
            ...
            if (dinning_prefect33) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect33: dinning_prefect33
                    },
                    success: function(data) {
            ...
            if (dinning_prefect34) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect34: dinning_prefect34
                    },
                    success: function(data) {
            ...
            if (dinning_prefect35) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect35: dinning_prefect35
                    },
                    success: function(data) {
            ...
            if (dinning_prefect36) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect36: dinning_prefect36
                    },
                    success: function(data) {
            ...
            if (dinning_prefect37) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect37: dinning_prefect37
                    },
                    success: function(data) {
            ...
            if (dinning_prefect38) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect38: dinning_prefect38
                    },
                    success: function(data) {
            ...
            if (dinning_prefect39) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect39: dinning_prefect39
                    },
                    success: function(data) {
            ...
            if (dinning_prefect40) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect40: dinning_prefect40
                    },
                    success: function(data) {
            ...
            if (dinning_prefect41) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect41: dinning_prefect41
                    },
                    success: function(data) {
            ...
            if (dinning_prefect42) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect42: dinning_prefect42
                    },
                    success: function(data) {
            ...
            if (dinning_prefect43) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect43: dinning_prefect43
                    },
                    success: function(data) {
            ...
            if (dinning_prefect44) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect44: dinning_prefect44
                    },
                    success: function(data) {
            ...
            if (dinning_prefect45) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect45: dinning_prefect45
                    },
                    success: function(data) {
            ...
            if (dinning_prefect46) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect46: dinning_prefect46
                    },
                    success: function(data) {
            ...
            if (dinning_prefect47) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect47: dinning_prefect47
                    },
                    success: function(data) {
            ...
            if (dinning_prefect48) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect48: dinning_prefect48
                    },
                    success: function(data) {
            ...
            if (dinning_prefect49) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect49: dinning_prefect49
                    },
                    success: function(data) {
            ...
            if (dinning_prefect50) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        dinning_prefect50: dinning_prefect50
                    },
                    success: function(data) {
