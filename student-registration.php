                        ...
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold active"><a class="collapsible-header waves-effect waves-cyan"><i
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        <li class="active"><a href="student-registration.php">STUDENT</a>
                                        </li>
                            ...
                            <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        ...
                                        <!-- <li><a href="school-prefect-result.php">DECLARE RESULT</a></li> -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="col s12 m12 l12">
                                            <p style="font-size:20px; font-weight: Bold;  " id="displayStudent">
                                                <marquee></marquee>
                                            </p>
                                        </div>
                                        <div class="col s12 m12 l12">
                                            ...
                                            <div class="row">
                                                <form action="" method="POST" id="formID" class="col s12">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <input id="course_program" name="course_program"
                                                                type="text">
                                    ...
                                    <div class="card-reveal">
                                        <span class="card-title grey-text text-darken-4">Registered Students <i
                                ...
                                <div class="card">
                                    <div class="card-move-up teal waves-effect waves-block waves-light">
                                        <div class="move-up">
                                            ...
                                            ?>
                                            <p class="margin white-text">Names of Voters
                                                (<?php if($checkTotalMessage <=0){ $checkTotalMessage = 0; echo $checkTotalMessage;}else{ echo $checkTotalMessage;};?>
                                                Registered Voters.)</p>
                                            <hr />
