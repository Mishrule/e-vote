                            ...
                            <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        ...
                                        <li><a href="display-result.php">DISPLAY RESULT</a>
                                        </li>
                            ...
                            <div class="col s12 m12 l6">
                                <ul id="projects-collection" class="collection">
                                    <li class="collection-item avatar">
                                        <i class="mdi-social-person-outline circle light-blue darken-2"></i>
                                        <span class="collection-header">USERS</span>
                                        <p>All Registered Users</p>
                                        <a href="#" class="secondary-content"><i class="mdi-action-grade"></i></a>
                                    </li>
                                    <?php
                                        $manageShow = '';
                                        $manageSQL = "SELECT * FROM useraccount";
                                        $manageResult = mysqli_query($conn, $manageSQL);
                                        while($manageRow = mysqli_fetch_array($manageResult)){
                                            $manageShow .= '
                                                <li class="collection-item">
                                                    <div class="row">
                                                        <div class="col s6">
                                                            <p class="collections-title">'.$manageRow['fullName'].'</p>
                                                            <p class="collections-content">'.$manageRow['username'].'</p>
                                                        </div>
                                                        <div class="col s3">
                                                            <span class="task-cat cyan">'.$manageRow['pass_word'].'</span>
                                                        </div>
                                                        <div class="col s3">
